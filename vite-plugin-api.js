            ...
            server.middlewares.use(async (req, res, next) => {
                ...
                try {
                    ...
                    if (parsed.pathname === '/api/chart') {
                        ...
                        const { getChartData } = await importLib('chart-api.js');
                    ...
                    if (parsed.pathname === '/api/search-symbols') {
                        ...
                        const { searchSymbols } = await importLib('search-symbols.js');
                    ...
                    if (parsed.pathname === '/api/quote') {
                        ...
                        const { getQuote } = await importLib('quote.js');
                    ...
                    if (parsed.pathname === '/api/news') {
                        ...
                        const { getNews } = await importLib('news-api.js');
